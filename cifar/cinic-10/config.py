...
class Config:
    def __init__(self, args):
        ...
        stage_choices = ['pretrain','validate','inversion','advtrain', 'noisytrain', 'antitrain', 'onlyX', 'Gan']
        stage = args.stage
        ...
        try:
            with open(config_dir, "r") as stream:
                ...
                if stage != 'pretrain' and stage != 'OnlyX' and stage != 'Gan':
